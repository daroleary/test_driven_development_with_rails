  ...
  describe "guest user" do
    describe "GET index" do
      ...
      it "assigns only public achievements to template" do
        ...
        FactoryGirl.create(:private_achievement)
  ...
  describe "authenticated user" do
    ...
    describe "POST create" do
      context "valid data" do
        # Must be a more elegant way to do this, this is apparently very slow as well
        let(:valid_data) {FactoryGirl.build(:public_achievement).attributes.except('id', 'created_at', 'updated_at')}
      ...
      context "invalid data" do
        # Must be a more elegant way to do this, this is apparently very slow as well
        let(:invalid_data) {FactoryGirl.build(:public_achievement, title: '').attributes.except('id', 'created_at', 'updated_at')}
